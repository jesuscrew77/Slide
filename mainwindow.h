...
private:
    ...
    void drawSlide(QSharedPointer <QImage> im, QVector<QImage>& imageVector, int  szX, int  sz_y, int space, int slideSizeX, int slideSizeY);
    void drawGridSlides(QSharedPointer <QImage> im, QImage &optImg, int  szX, int  sz_y, int space, int slideSizeX, int slideSizeY);
    void chooseTab();
